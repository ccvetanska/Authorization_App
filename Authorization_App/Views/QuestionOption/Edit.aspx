...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
        ...
        <asp:FormView runat="server"
            ItemType="Authorization_App.Model.QuestionOption, Authorization_App.Model" DefaultMode="Edit" DataKeyNames="Id"
            ...
            <EditItemTemplate>
                <fieldset class="form-horizontal">
					...
					<asp:ValidationSummary runat="server" CssClass="alert alert-danger"  />                 
                            ...
                            <asp:DynamicControl Mode="Edit" DataField="Content" runat="server" />
